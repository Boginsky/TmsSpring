        ...
        <div class="d-flex flex-lg-row flex-column-reverse">
            <div class="card card1">
                ...
                <div class="bottom text-center mb-5">
                    <p href="#" class="sm-text mx-auto mb-3">Don't have an account? <a href="/WebProjectTms_war_exploded/registration">Create new</a></p>
                </div>
            </div>
            <div class="card card2">
                <div class="my-auto mx-md-5 px-md-5 right">
                    <h3 class="text-white">Make your life organized</h3> <small class="text-white">This app is designed to create your own todo list, organize your daily routine, and build good habits.</small>
                </div>
            </div>
        </div>
    </div>
